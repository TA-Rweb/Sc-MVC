...
<head>
    ...
    <title>TopUp | Mobile Legend</title>
...
<div class="container">
    ...
    <div class="nk-store nk-store-checkout">
        <h3 class="nk-decorated-h-2"><span><span class="text-main-1">MOBILE</span> LEGEND</span></h3>
        ...
        <form action="#" class="nk-form">
            <div class="row vertical-gap">
                <div class="col-lg-6">
                    <div class="row vertical-gap">
                        <div class="col-sm-6">
                            <label for="fname">ID <span class="text-main-1">*</span> :</label>
                ...
                <div class="nk-feature-10">
                    ...
                    <a class="nk-nav-logo">
                        <img src="<?php echo base_url('/assets/gaming/') ?>assets/images/mlml.jpg" alt="" width="300">
                    </a>
                    </div>
                </div>
            </div>

...
<div class="container">
    ...
    <div class="nk-store nk-store-checkout">
        <h3 class="nk-decorated-h-2"><span><span class="text-main-1">GENSHIN</span> IMPACT</span></h3>
        ...
        <form action="#" class="nk-form">
            <div class="row vertical-gap">
                ...
                <div class="nk-feature-10">
                    ...
                    <a class="nk-nav-logo">
                        <img src="<?php echo base_url('/assets/gaming/') ?>assets/images/gigi.webp" alt="" width="300">
                    </a>
                    </div>
                </div>
            </div>

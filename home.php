...
<head>
    ...
    <!-- FontAwesome -->
    <script defer src="<?php echo base_url('/assets/gaming/') ?>assets/vendor/fontawesome-free/js/all.js"></script>
    <script defer src="<?php echo base_url('/assets/gaming/') ?>assets/vendor/fontawesome-free/js/v4-shims.js"></script>
...
<!-- END: Top Contacts -->
    ...
    <nav class="nk-navbar nk-navbar-top nk-navbar-sticky nk-navbar-autohide">
        <div class="container">
            <div class="nk-nav-table">
                ...
                <a href="<?php echo base_url('index.php/topup_controller/home') ?>" class="nk-nav-logo">
                    <img src="<?php echo base_url('/assets/gaming/') ?>assets/images/paws.png" alt="PawTopia" width="109">
                </a>
        ...
        <!-- <li class=" nk-drop-item">
            <a href="<?php echo base_url('/assets/gaming/') ?>store.html">
                Store
        ...
        <li>
            <a href="<?php echo base_url('/assets/gaming/') ?>store-product.html">
                Product
                
            </a>
        </li>
        <li>
            <a href="<?php echo base_url('/assets/gaming/') ?>store-catalog.html">
                Catalog
                
            </a>
        </li>
        <li>
            <a href="<?php echo base_url('/assets/gaming/') ?>store-catalog-alt.html">
                Catalog Alt
                
            </a>
        </li>
        <li>
            <a href="<?php echo base_url('/assets/gaming/') ?>store-checkout.html">
                Checkout
                
            </a>
        </li>
        <li>
            <a href="<?php echo base_url('/assets/gaming/') ?>store-cart.html">
                Cart
    ...
    <div class="nano">
        <div class="nano-content">
            <a href="<?php echo base_url('/assets/gaming/') ?>index.html" class="nk-nav-logo">
                <img src="<?php echo base_url('/assets/gaming/') ?>assets/images/paws.png" alt="" width="120">
            </a>
...
<div class="container">
    ...
    <div class="nk-image-slider" data-autoplay="2000">
        ...
        <div class="nk-image-slider-item">
            <img src="<?php echo base_url('/assets/gaming/') ?>assets/images/ml2.png" alt="" class="nk-image-slider-img" data-thumb="<?php echo base_url('/assets/gaming/') ?>assets/images/ml2.png">
        </div>
        
        <div class="nk-image-slider-item">
            <img src="<?php echo base_url('/assets/gaming/') ?>assets/images/gi.webp" alt="" class="nk-image-slider-img" data-thumb="<?php echo base_url('/assets/gaming/') ?>assets/images/gi.webp">
        </div>
        
        <div class="nk-image-slider-item">
            <img src="<?php echo base_url('/assets/gaming/') ?>assets/images/hsr1.jpg" alt="" class="nk-image-slider-img" data-thumb="<?php echo base_url('/assets/gaming/') ?>assets/images/hsr1.jpg">
        </div>

        <div class="nk-image-slider-item">
            <img src="<?php echo base_url('/assets/gaming/') ?>assets/images/hsr2.jpg" alt="" class="nk-image-slider-img" data-thumb="<?php echo base_url('/assets/gaming/') ?>assets/images/hsr2.jpg">
        </div>
    ...
    <!-- START: Latest News -->
    <div class="nk-gap-2"></div>
    <h3 class="nk-decorated-h-2"><span><span class="text-main-1">Berita</span> Terakhir</span></h3>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-3">
                ...
                <div class="nk-blog-post">
                    <a class="nk-post-img">
                        <img src="<?php echo base_url('/assets/gaming/') ?>assets/images/ml3.jpg" alt="MOBILE LEGEND">
                        
                        <span class="nk-post-categories">
                                    <span class="bg-main-5">MOBA</span>
                                </span>
                        
                    </a>
                    <div class="nk-gap"></div>
                    <h2 class="nk-post-title h4"><a>MOBILE LEGEND</a></h2>
                    <div class="nk-post-text">
                        <p>Mobile Legends: Bang Bang adalah sebuah permainan mobile MOBA (Multiplayer Online Battle Arena) yang dikembangkan dan diterbitkan oleh Moonton. Permainan ini dirancang untuk dimainkan...</p>
                    </div>
                    <div class="nk-gap"></div>
                    <a href="<?php echo base_url('/assets/gaming/') ?>store-checkout.html" class="nk-btn nk-btn-rounded nk-btn-color-dark-3 nk-btn-hover-color-main-1">TopUp</a>
                    <div class="nk-post-date float-right"><span class="fa fa-calendar"></span> 09 Juli 2023</div>
                </div>
                <!-- END: Post -->
            </div>
            ...
            <div class="col-md-6 col-lg-3">
                ...
                <div class="nk-blog-post">
                    <a class="nk-post-img">
                        <img src="<?php echo base_url('/assets/gaming/') ?>assets/images/gi.jpg" alt="At first, for some time, I was not able to answer">
                        
                        <span class="nk-post-categories">
                                    <span class="bg-main-5">Adventure</span>
                                </span>
                        
                    </a>
                    <div class="nk-gap"></div>
                    <h2 class="nk-post-title h4"><a>GENSHIN IMPACT</a></h2>
                    <div class="nk-post-text">
                        <p>Genshin Impact adalah permainan aksi petualangan yang dikembangkan oleh miHoYo. Permainan ini dirancang untuk dimainkan di berbagai platform, termasuk PC, PlayStation 4, PlayStation 5, iOS, dan Android.</p>
                    </div>
                    <div class="nk-gap"></div>
                    <a href="<?php echo base_url('/assets/gaming/') ?>store-checkout.html" class="nk-btn nk-btn-rounded nk-btn-color-dark-3 nk-btn-hover-color-main-1">TOPUP</a>
                    <div class="nk-post-date float-right"><span class="fa fa-calendar"></span> 07 Juli 2023</div>
                </div>
                <!-- END: Post -->
            </div>
            ...
            <div class="col-md-6 col-lg-3">
                ...
                <div class="nk-blog-post">
                    <a class="nk-post-img">
                        <img src="<?php echo base_url('/assets/gaming/') ?>assets/images/hsr.jpg" alt="At length one of them called out in a clear">
                        
                        <span class="nk-post-categories">
                                    <span class="bg-main-6">TurnBase</span>
                                </span>
                        
                    </a>
                    <div class="nk-gap"></div>
                    <h2 class="nk-post-title h4"><a>HONKAI: STAR RAIL</a></h2>
                    <div class="nk-post-text">
                        <p>Honkai: Star Rail mengikuti gaya alur permainan dari permainan bermain peran Jepang klasik: pemain membangun barisan karakter, dan mengontrol tim beranggotakan empat orang dalam pertarungan berbasis giliran.</p>
                    </div>
                    <div class="nk-gap"></div>
                    <a href="<?php echo base_url('/assets/gaming/') ?>store-checkout.html" class="nk-btn nk-btn-rounded nk-btn-color-dark-3 nk-btn-hover-color-main-1">TOPUP</a>
                    <div class="nk-post-date float-right"><span class="fa fa-calendar"></span> 08 Juli 2023</div>
                </div>
                <!-- END: Post -->
            </div>
            ...
            <h3 class="nk-decorated-h-2"><span><span class="text-main-1">Rekom</span>endasi</span></h3>
            <div class="nk-gap"></div>
            <div class="row vertical-gap">
                ...
                <div class="col-md-6">
                    <div class="nk-product-cat">
                        <a class="nk-product-image" href="<?php echo base_url('/assets/gaming/') ?>store-product.html">
                            <img src="<?php echo base_url('/assets/gaming/') ?>assets/images/mlp.jpg" alt="Mobile Legend">
                        </a>
                        <div class="nk-product-cont">
                            <h3 class="nk-product-title h5"><a href="<?php echo base_url('/assets/gaming/') ?>store-product.html">Mobile Legend</a></h3>
                            <div class="nk-gap-1"></div>
                            ...
                            <div class="nk-gap-1"></div>
                            <div class="nk-product-price">Rp 165.000</div>
                            <div class="nk-gap-1"></div>
                            <a href="#" class="nk-btn nk-btn-rounded nk-btn-color-dark-3 nk-btn-hover-color-main-1"><span class="fa fa-shopping-cart"></span></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="nk-product-cat">
                        <a class="nk-product-image" href="store-product.html">
                            <img src="<?php echo base_url('/assets/gaming/') ?>assets/images/qq.png" alt="So saying he unbuckled">
                        </a>
                        <div class="nk-product-cont">
                            <h3 class="nk-product-title h5"><a href="<?php echo base_url('/assets/gaming/') ?>store-product.html">Genshin Impact</a></h3>
                            <div class="nk-gap-1"></div>
                            <div class="nk-product-rating" data-rating="5"> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i></div>
                            <div class="nk-gap-1"></div>
                            <div class="nk-product-price">Rp 79.000</div>
                            <div class="nk-gap-1"></div>
                            <a href="#" class="nk-btn nk-btn-rounded nk-btn-color-dark-3 nk-btn-hover-color-main-1"><span class="fa fa-shopping-cart"></span></a>
                        </div>
                    </div>
...
<!-- END: Footer -->
    ...
    <img class="nk-page-background-top" src="<?php echo base_url('/assets/gaming/') ?>assets/images/bg-top.png" alt="">

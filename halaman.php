        ...
        <div class="row vertical-gap">
            <div class="col-lg-3">
                <div class="nk-feature-2">
                    ...
                    <a target="_blank" href="https://play.google.com/store/apps/details?id=com.mobile.legends" class="nk-nav-logo">
                        <img src="<?php echo base_url('/assets/gaming/') ?>assets/images/mlml.jpg" alt="" width="120">
                    </a>
                    </div>
                </div>
            </div>
            <div class="col-lg-3">
                <div class="nk-feature-2">
                    <div class="nk-feature-icon">
                    <a target="_blank" href="https://genshin.hoyoverse.com/en" class="nk-nav-logo">
                        <img src="<?php echo base_url('/assets/gaming/') ?>assets/images/gigi.webp" alt="" width="120">
                    </a>
                    </div>
                </div>
            </div>
            <div class="col-lg-3">
                <div class="nk-feature-2">
                    <div class="nk-feature-icon">
                    <a target="_blank" href="https://hsr.hoyoverse.com/ua?utm_source=SEA_Bing_SEA_search_UA2_Brand&hoyotrace_channel=bing_channel&msclkid=91d23f2cd0621d8905385b86f521b9b7" class="nk-nav-logo">
                        <img src="<?php echo base_url('/assets/gaming/') ?>assets/images/hsrhsr.jpg" alt="" width="120">
                    </a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-7">
                ...
                <div class="nk-tabs">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" href="#tabs-1-1" role="tab" data-toggle="tab">1</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#tabs-1-2" role="tab" data-toggle="tab">2</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#tabs-1-3" role="tab" data-toggle="tab">3</a>
                        </li>
                    </ul>
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane fade show active" id="tabs-1-1">
                            <div class="nk-gap"></div>
                            <p>Dengan top up game di website kami, Anda dapat dengan mudah dan cepat menambah saldo permainan Anda tanpa harus keluar rumah. Tersedia berbagai metode pembayaran yang aman dan nyaman, sehingga Anda dapat melakukan top up kapan saja dan di mana saja.</p>
                            <div class="nk-gap"></div>
                        </div>
                        <div role="tabpanel" class="tab-pane fade" id="tabs-1-2">
                            <div class="nk-gap"></div>
                            <p>Dengan melakukan top up game di website kami, Anda akan langsung mendapatkan akses ke game favorit Anda. Tidak perlu menunggu lama atau menghabiskan waktu mencari voucher fisik. Top up langsung dilakukan secara digital, sehingga Anda bisa segera memulai petualangan dalam permainan kesukaan Anda.</p>
                            <div class="nk-gap"></div>
                        </div>
                        <div role="tabpanel" class="tab-pane fade" id="tabs-1-3">
                            <div class="nk-gap"></div>
                            <p>Kami menjaga keamanan dan kerahasiaan data pribadi Anda dengan sungguh-sungguh. Dengan sistem pembayaran yang terpercaya dan enkripsi yang kuat, Anda dapat melakukan top up dengan tenang tanpa khawatir akan kebocoran informasi. Kami berkomitmen memberikan pengalaman top up yang aman dan terpercaya bagi para pengguna kami.</p>
                            <div class="nk-gap"></div>
                        </div>
                    </div>
                </div>
